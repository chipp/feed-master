...
feeds = [
    ("Все так",         "http://echo.msk.ru/programs/vsetak/rss-audio.xml"),
    ("Все так +",       "http://echo.msk.ru/programs/vsetakplus/rss-audio.xml"),
    ("Вот так",         "http://echo.msk.ru/programs/vottak/rss-audio.xml"),
    ("Дилентанты",      "http://echo.msk.ru/programs/Diletanti/rss-audio.xml"),
    ("Разбор полета",   "http://echo.msk.ru/programs/razbor_poleta/rss-audio.xml"),
    ("48 минут",        "http://echo.msk.ru/programs/48minut/rss-audio.xml"),
    ("A-Team",          "http://echo.msk.ru/programs/a_team/rss-audio.xml")
]
